...
import 'package:motorbikesafety/WardenScreens/OtherScreens/WardenEditProfilePage.dart';

class WardenProfilePage extends StatefulWidget {
  @override
  State<WardenProfilePage> createState() => _ProfilePageState();
}

class _ProfilePageState extends State<WardenProfilePage> {
          ...
          IconButton(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      WardenEditAdminProfilePage(wardenDetails: wardenDetails),
                ),
              ).then((updatedDetails) {
